...
Once the benchmarks complete, the results will be saved locally in the `results/` directory as CSV reports (e.g., `read_combined_report.csv`). If configured correctly, `run.sh` will also attempt to upload these results to BigQuery.
