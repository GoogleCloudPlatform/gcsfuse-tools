...
# #2 Benchmark
# bash run-benchmarks.sh change-default-configs-for-streaming-writes gcs-fuse-test us-south1 n2-standard-96 ubuntu-2004-lts ubuntu-os-cloud
# bash create_benchmark_tables.sh change-default-configs-for-streaming-writes us-south1 c4-standard-96 'gVNIC+ tier_1 networking (100Gbps)' 'SSD persistent disk'
