# GKE GenAI Log analyzer 🕵️‍♂️

**GKE GenAI Log analyzer** is a CLI tool written in Go that automates the debugging of GCSFuse sidecar errors in Google Kubernetes Engine (GKE).
...
The tool will output a **GKE GenAI Log analyzer Report** generated by Gemini, summarizing the findings directly in your terminal.