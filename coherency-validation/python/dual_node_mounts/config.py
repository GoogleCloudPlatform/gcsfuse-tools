...
# Current Script: .../python/dual_node_mounts/config.py
# PKG_ROOT: .../python
...
# Tasks/Logs: .../tasks/coherency-validation/python/dual_node_mounts
WORK_DIR = os.path.join(WORK_ROOT_BASE, "coherency-validation", "python", "dual_node_mounts")
...
MOUNT_PATH = MOUNT_PATH_TEMPLATE.format(MOUNT_NUMBER)
