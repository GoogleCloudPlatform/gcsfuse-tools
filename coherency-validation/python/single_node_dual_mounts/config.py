...
# Current Script: .../python/single_node_dual_mounts/config.py
# PKG_ROOT: .../python
...
# Tasks/Logs: .../tasks/coherency-validation/python/single_node_dual_mounts
WORK_DIR = os.path.join(WORK_ROOT_BASE, "coherency-validation", "python", "single_node_dual_mounts")
...
MOUNT_PATH_1 = MOUNT_PATH_TEMPLATE.format(1)
MOUNT_PATH_2 = MOUNT_PATH_TEMPLATE.format(2)
