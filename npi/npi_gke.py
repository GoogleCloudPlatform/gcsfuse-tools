...
def main():
    ...
    all_benchmarks = [
        ...
        ("read", "http1", "fio-read-benchmark", "--machine-type=a2-megagpu-16g", None, None),
        ("read", "grpc", "fio-read-benchmark", "--client-protocol=grpc,--machine-type=a2-megagpu-16g", None, None),
        ("write", "http1", "fio-write-benchmark", "--machine-type=a2-megagpu-16g", None, None),
        ("write", "grpc", "fio-write-benchmark", "--client-protocol=grpc,--machine-type=a2-megagpu-16g", None, None),
        ("read_file_cache", "grpc", "fio-read-benchmark", f"client-protocol=grpc,machine-type=a2-megagpu-16g,metadata-cache-ttl-secs=-1,file-cache:max-size-mb:{args.file_cache_size_mb},file-cache-cache-file-for-range-read", 5, "--keep-mount"),
